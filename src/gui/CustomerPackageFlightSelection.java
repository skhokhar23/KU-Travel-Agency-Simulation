...
public class CustomerPackageFlightSelection {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomerPackageFlightSelection window = new CustomerPackageFlightSelection();
	 ...
	 */
	public CustomerPackageFlightSelection() {
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CustomerMainMenu a= new CustomerMainMenu();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CustomerPackageFlightSelection b = new CustomerPackageFlightSelection();
			...
			public void actionPerformed(ActionEvent e) {
        		...
        		try {
        			...
        			if(!returnFlightDate.isBefore(flightDate)&& !returnFlightDate.isEqual(flightDate)&&!returnFlightDate.isAfter(flightDate.plusDays(10))) {
                        ...
                        CustomerHotelSelection  hotelSelectionPage= new  CustomerHotelSelection();
